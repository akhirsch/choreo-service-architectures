...
\newcommand{\Eve}{\LocFont{E}}    
\newcommand{\Server}{\LocFont{S}}
\newcommand{\ProcP}{\LocFont{P}}
\newcommand{\ProcQ}{\LocFont{Q}}    
...
\newcommand{\multircv}[2][chorcolor]{\mathrel{\mathchoice%
  {\mathord{\color{#1}\sendsto}\mkern-2mu\raisebox{0.125ex}{$\scriptstyle{\color{#1}[}#2{\color{#1}]}$}}
  {\mathord{\color{#1}\sendsto}\mkern-2mu\raisebox{0.125ex}{$\scriptstyle{\color{#1}[}#2{\color{#1}]}$}}
  {\mathord{\color{#1}\sendsto}\mkern-1mu\raisebox{0.1ex}{$\scriptstyle{\color{#1}[}#2{\color{#1}]}$}\mkern3mu}
  {\mathord{\color{#1}\sendsto}\mkern-1mu\raisebox{0.05ex}{$\scriptstyle{\color{#1}[}#2{\color{#1}]}$}\mkern3mu}%
}}
...
\newcommand{\Own}[2]{\ensuremath{{#1}.{#2}}}
