...
%Moreover, we will integrate this new feature with a host of modern choreographic advances,
%including higher-order functions and process polymorphism.

%Each of these features will leverage recent work by the PIs on first-class process polymorphism~\citep{SamuelsonHC25}.
